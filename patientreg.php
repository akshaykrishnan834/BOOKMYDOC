...
<body>
    <div class="form-box">
        ...
        <h3>Create Your Account As Patient</h3>
        ...
        <form method="post" action="patientconnect.php" id="signupForm" novalidate>
            ...
            <div class="already-account">
                <p>Already have an account? <a href="patientlog.php">Log in</a></p>
            </div>
