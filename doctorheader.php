...
$profilePic = !empty($row['profile_photo']) ? $row['profile_photo'] : 'default-profile.png';
?>
        ...
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="dashboard.php">
                ...
                <div class="brand-text">
                    ...
                    <span class="tagline">Doctor Panel</span>
                </div>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="manageappointments.php">
                            <i class="fas fa-user-md me-1"></i> Appointments
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="availableslots.php">
                            <i class="far fa-calendar-check me-1"></i> Available Slots
                        </a>
                    </li>
                    <li class="nav-item">
