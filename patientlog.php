...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($email) && !empty($password)) {
        $stmt = $conn->prepare("SELECT * FROM patientreg WHERE email = ?");
...
<body>
    <div class="form-box">
        ...
        <h3 style="color: #333;">Login To Enter As A Patient</h3>
        ...
        <div class="forgot-password">
            <a href="patientforgotpassword.php">Forgot password?</a>
        </div>
        <div class="form-footer">
            <p>Don't have an account? <a href="patientreg.php">Sign Up</a></p>
        </div>
