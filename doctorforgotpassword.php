...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['email'])) {
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $stmt = $pdo->prepare("SELECT * FROM doctorreg WHERE email = :email");
        ...
        if ($stmt->rowCount() > 0) {
            ...
            if (sendVerificationEmail($email, $verificationCode)) {
                ...
                header('Location: doctorverifyotp.php');
                exit();
            } else {
...
<body>
    <div class="form-box">
        ...
        <div class="form-footer">
            <p>Remember your password? <a href="doctorlog.php">Login here</a></p>
        </div>
