...
// If profile picture exists, use it; otherwise, set a default
$profilePic = !empty($row['profile_pic']) ? $row['profile_pic'] : 'default-profile.png';
?>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
        ...
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="dashboard.php">
                ...
                <div class="brand-text">
                    ...
                    <span class="tagline">Patient Panel</span>
                </div>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="patientprofile.php">
                            <i class="fas fa-home me-1"></i> Home
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="browsedoct.php">
                            <i class="fas fa-user-md me-1"></i> Browser Doc
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="appointmentstat.php">
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
            <li><a class="dropdown-item" href="display_patients.php"><i class="fas fa-id-card me-2"></i>Profile</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item text-danger" href="patientlogout.php"><i class="fas fa-sign-out-alt me-2"></i>Logout</a></li>
        </ul>
    </div>
</div>
